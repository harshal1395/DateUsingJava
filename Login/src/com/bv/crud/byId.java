...
public class byId extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		while (size < list.size()) {
			...
			Date manufacturedate = list.get(size).getManufactureDate();
			if (id1 == id) {
				out.print("<h4>Product Details</h4>");
				out.print("<table border='5' align='center' color=''><tr><td>ID</td><td>PRODUCTNAME</td><td>MANUFACTURERNAME</td><td>PRICE</td><td>MANUFACTUREDATE</td></tr>");
				out.print("<tr><td>" + id + "</td>");
				out.print("<td>" + productname + "</td>");
				out.print("<td>" + manufacturername + "</td>");
				out.print("<td>" + price + "</td>");
				out.print("<td>" + manufacturedate + "</td>");
